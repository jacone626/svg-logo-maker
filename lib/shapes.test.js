...
describe('Test', () => {
  ...
  describe('Square', () => {
    it('should return true if a square was rendered', () => {
        ...
        expect(shape.render()).toEqual(`<rect x="50" width="200" height="200" fill="${this.shapeColor}"/>`);
    });
  });
  ...
  describe('Triangle', () => {
    it('should return true if a triangle was rendered', () => {
        ...
        expect(shape.render()).toEqual(`<polygon points="0, 200 300,200 150, 0" fill="${this.shapeColor}"/>`);
    });
  });
